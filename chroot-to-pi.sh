...
# mount partition
mount -o rw ${1}3  /mnt/kali
mount -o rw ${1}1 /mnt/kali/boot
...
# ld.so.preload fix
#sed -i 's/^/#CHROOT /g' /mnt/kali/etc/ld.so.preload
...
# chroot to raspbian
env LANG=C chroot /mnt/kali /bin/bash
...
# unmount everything
umount /mnt/kali/{dev/pts,dev,sys,proc,boot,}